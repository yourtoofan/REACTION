        ...
        for member in message.new_chat_members:
            ...
            if member.id == client.id:
                try:
                    ...
                    await message.reply_photo(photo=random.choice(IMG), caption=START.format(chat.mention or "can't mention", users, chats), reply_markup=reply_markup)
...
async def start(client: Client, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        await m.reply_photo(photo=chat_photo, caption=START.format(chat.mention or "can't mention", users, chats, UP), reply_markup=InlineKeyboardMarkup(START_BOT))
