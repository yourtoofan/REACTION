...
async def start(client: Client, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        await m.reply_photo(photo=chat_photo, caption=START.format(m.chat.first_name or "can't mention", users, chats, UP), reply_markup=InlineKeyboardMarkup(START_BOT))
