...
async def chatbot_response(client: Client, message: Message):
    try:
        ...
        if (message.reply_to_message and message.reply_to_message.from_user.id == client.me.id) or not message.reply_to_message and not message.from_user.id == nexichat.id:
